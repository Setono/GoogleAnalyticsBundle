        ...
        $rootNode
            ...
            ->children()
                ...
                ->arrayNode('tag_manager')
                    ->canBeEnabled()
                    ->children()
                        ->scalarNode('data_layer_variable')
                            ->info('The name of the data layer variable in your application')
                        ...
                        ->arrayNode('containers')
                            ...
                            ->arrayPrototype()
                                ->children()
                                    ...
                                    ->end()
                                    ->arrayNode('property')
                                        ->info('Only set the associated property if you need to send server side events from within your Symfony application')
                                        ->addDefaultsIfNotSet()
                                        ->children()
                                            ->scalarNode('measurement_id')->isRequired()->cannotBeEmpty()->end()
